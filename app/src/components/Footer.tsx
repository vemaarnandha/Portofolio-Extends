        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://wa.me/6281916635780" target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-xl bg-arcane-900/50 flex items-center justify-center text-arcane-400 hover:bg-arcane-500 hover:text-void-950 transition-all duration-300 border border-arcane-800/50 shadow-glow-sm">
              ...
              <a href="mailto:kologes4@gmail.com" className="h-10 w-10 rounded-xl bg-arcane-900/50 flex items-center justify-center text-arcane-400 hover:bg-arcane-500 hover:text-void-950 transition-all duration-300 border border-arcane-800/50 shadow-glow-sm">
